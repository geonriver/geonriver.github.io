(() => {
    ...
    (() => {
        ...
        function initSliders() {
            ...
            if (document.querySelector(".images-product__thumbs1")) {
                const thumbsSwiper = new core(".images-product__thumbs1", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
                ...
                new core(".images-product1__slider", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
            ...
            if (document.querySelector(".images-product__thumbs2")) {
                const thumbsSwiper = new core(".images-product__thumbs2", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
                ...
                new core(".images-product2__slider", {
                    modules: [ Navigation, Pagination, Autoplay, Thumb ],
                    observer: true,
                    watchOverflow: true,
                    observeParents: true,
        ...
        const revealElementOnScroll = function() {
            for (let i = 0, len = revealElements.length; i < len; i++) {
                ...
                if (isElementInsideWindow) revealElements[i].classList.add("revealed");
            }
        };
        window.addEventListener("scroll", revealElementOnScroll);
        let box = document.querySelectorAll(".produce__box");
        box.forEach((video => video.addEventListener("click", (() => {
        ...
        document.querySelectorAll(".smallFail").forEach((image => {
            image.onclick = () => {
                document.querySelector(".popup-image").style.display = "block";
                document.querySelector(".popup-image img").src = image.getAttribute("src");
            };
        }));
        let closePop = document.querySelector(".popup-image span");
        if (closePop) closePop.onclick = () => {
            document.querySelector(".popup-image").style.display = "none";
        };
        document.querySelectorAll(".bigFail").forEach((image => {
            image.onclick = () => {
                document.querySelector(".popup-bigFail").style.display = "block";
            };
        }));
        let closeBigPop = document.querySelector(".popup-bigFail span");
        if (closeBigPop) closeBigPop.onclick = () => {
            document.querySelector(".popup-bigFail").style.display = "none";
        };
        document.querySelectorAll(".bigFail2").forEach((image => {
            image.onclick = () => {
                document.querySelector(".popup-bigFail2").style.display = "block";
            };
        }));
        let closeBigPop2 = document.querySelector(".popup-bigFail2 span");
        if (closeBigPop2) closeBigPop2.onclick = () => {
            document.querySelector(".popup-bigFail2").style.display = "none";
        };
        const optionsInputs = document.querySelectorAll(".options__label");
        ...
        const langChange = document.querySelector(".lang__change");
        const langSelected = langChange.querySelector(".lang__selected");
        langChange.querySelector(".lang__options");
        const langOption = langChange.querySelectorAll(".lang__option");
        langSelected.addEventListener("click", (() => {
            langChange.classList.toggle("active");
        }));
        langOption.forEach((option => {
            option.addEventListener("click", (() => {
                option.dataset.value;
                langSelected.textContent = option.textContent;
                langChange.classList.remove("active");
            }));
        }));
        window["FLS"] = true;
        isWebp();
